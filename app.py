...
def api_generate_video():
    """
    Generate a video from a normal-language description and duration.
    """
...
def api_download(project, filename):
    ...
    so the token can also be supplied as a query parameter.
    """
